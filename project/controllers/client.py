...
def user_index():
    ...
    return render_template("dashboard/user.html", users=users)

@app.route("/users/create")
@login_required
def user_add():
    return render_template("dashboard/form.html", card_title="Add User")
...
def user_edit(id):
    ...
    return render_template("dashboard/form.html", card_title="Edit User", user=user)
